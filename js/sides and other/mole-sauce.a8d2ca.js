...
var e=document.querySelector('.un29');e.setAttribute('src',(dpi>1)?'../images/clipart3465842-30.png':'../images/clipart3465842-15.png');}else if($(window).width()>=480){var e=document.querySelector('.un25');e.setAttribute('src',(dpi>1)?'../images/clipart3465842-18.png':'../images/clipart3465842-9.png');
var e=document.querySelector('.un27');e.setAttribute('src',(dpi>1)?'../images/mole-negro-sauce-14-228.jpg':'../images/mole-negro-sauce-14-114.jpg');
var e=document.querySelector('.un28');e.setAttribute('src',(dpi>1)?'../images/molesauce-228.jpeg':'../images/molesauce-114.jpeg');
var e=document.querySelector('.un29');e.setAttribute('src',(dpi>1)?'../images/clipart3465842-18-1.png':'../images/clipart3465842-9-1.png');}else{var e=document.querySelector('.un25');e.setAttribute('src',(dpi>1)?'../images/clipart3465842-12.png':'../images/clipart3465842-6.png');
var e=document.querySelector('.un27');e.setAttribute('src',(dpi>1)?'../images/mole-negro-sauce-14-152.jpg':'../images/mole-negro-sauce-14-76.jpg');
var e=document.querySelector('.un28');e.setAttribute('src',(dpi>1)?'../images/molesauce-152.jpeg':'../images/molesauce-76.jpeg');
var e=document.querySelector('.un29');e.setAttribute('src',(dpi>1)?'../images/clipart3465842-14-1.png':'../images/clipart3465842-7.png');}}};
